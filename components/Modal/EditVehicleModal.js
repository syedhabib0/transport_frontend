...
const EditVehicleModal = ({ isOpen, onClose, onSubmit, userId, vehicleId ,truckTypes}) => {
  ...
  useEffect(() => {
    const fetchVehicleData = async () => {
      try {
        const response = await axios.get(`${baseUrl}/drivers/${userId}/getVehicles/${vehicleId}`,{headers:{Authorization:`Bearer ${access_token}`}});
    ...
    if (isOpen && userId && vehicleId) {
      fetchVehicleData();
    }
  }, [isOpen, userId, vehicleId,access_token]);

  const initialValues = {
    vehicle_type: currentVehicle?.vehicle_type ?? "",
    unit_number: currentVehicle?.unit_number ?? "",
    make: currentVehicle?.make ?? "",
    model: currentVehicle?.model ?? "",
    payload_weight: currentVehicle?.payload_weight ?? "",
    length: currentVehicle?.other_details?.length ?? "",
    width: currentVehicle?.other_details?.width ?? "",
    height: currentVehicle?.other_details?.height ?? "",
    dimension_in: currentVehicle?.other_details?.dimension_in ?? "",
    is_available: currentVehicle?.other_details?.is_available ?? false,
    lift_gate: currentVehicle?.other_details?.lift_gate ?? false,
    hazmat: currentVehicle?.other_details?.hazmat ?? false,
    icc_bar: currentVehicle?.other_details?.icc_bar ?? false,
    tsa: currentVehicle?.other_details?.tsa ?? false,
    twic: currentVehicle?.other_details?.twic ?? false,
    pallet_jack: currentVehicle?.other_details?.pallet_jack ?? false,
    true_dock_high: currentVehicle?.other_details?.true_dock_high ?? false,
    tanker_endorsement: currentVehicle?.other_details?.tanker_endorsement ?? false,
    license_plate_image:
      currentVehicle?.license_details?.license_plate_image ?? "/assets/images/placeholder.jpg",
    state: currentVehicle?.license_details?.license_plate_state ?? "",
    license_expiry: currentVehicle?.license_details?.license_plate_expiry ?? "",
    is_expirable: currentVehicle?.license_details?.is_expirable ?? false,
    front_image: currentVehicle?.vehicle_images?.front_image ?? "/assets/images/placeholder.jpg",
    back_image: currentVehicle?.vehicle_images?.back_image ?? "/assets/images/placeholder.jpg",
    left_image: currentVehicle?.vehicle_images?.left_image ?? "/assets/images/placeholder.jpg",
    right_image: currentVehicle?.vehicle_images?.right_image ?? "/assets/images/placeholder.jpg",
    cargo_image: currentVehicle?.vehicle_images?.cargo_image ?? "/assets/images/placeholder.jpg",
  };
                ...
                <Col md={4}>
                  <FormGroup>
                    <InputCustom
                      ...
                      isCheck={true}
                      onChange={formik.handleChange}
                      // value={formik.values.lift_gate}
                      checked={formik.values.lift_gate}
                      onBlur={formik.handleBlur}
                      isInvalid={formik.touched.lift_gate && !!formik.errors.lift_gate}
                      feedbackError={formik.errors.lift_gate}
                    />
                  </FormGroup>
                </Col>
                <Col md={4}>
                  <FormGroup>
                    <InputCustom
                      ...
                      isCheck={true}
                      onChange={formik.handleChange}
                      // value={formik.values.hazmat}
                      checked={formik.values.hazmat}
                      onBlur={formik.handleBlur}
                      isInvalid={formik.touched.hazmat && !!formik.errors.hazmat}
                      feedbackError={formik.errors.hazmat}
                    />
                  </FormGroup>
                </Col>
                <Col md={4}>
                  <FormGroup>
                    <InputCustom
                      ...
                      isCheck={true}
                      onChange={formik.handleChange}
                      // value={formik.values.icc_bar}
                      checked={formik.values.icc_bar}
                      onBlur={formik.handleBlur}
                      isInvalid={formik.touched.icc_bar && !!formik.errors.icc_bar}
                      feedbackError={formik.errors.icc_bar}
                    />
                  </FormGroup>
                </Col>
                <Col md={4}>
                  <FormGroup>
                    <InputCustom
                      ...
                      isCheck={true}
                      onChange={formik.handleChange}
                      // value={formik.values.tsa}
                      checked={formik.values.tsa}
                      onBlur={formik.handleBlur}
                      isInvalid={formik.touched.tsa && !!formik.errors.tsa}
                      feedbackError={formik.errors.tsa}
                    />
                  </FormGroup>
                </Col>
                <Col md={4}>
                  <FormGroup>
                    <InputCustom
                      ...
                      isCheck={true}
                      onChange={formik.handleChange}
                      // value={formik.values.twic}
                      checked={formik.values.twic}
                      onBlur={formik.handleBlur}
                      isInvalid={formik.touched.twic && !!formik.errors.twic}
                      feedbackError={formik.errors.twic}
                    />
                  </FormGroup>
                </Col>
                <Col md={4}>
                  <FormGroup>
                    <InputCustom
                      ...
                      isCheck={true}
                      onChange={formik.handleChange}
                      // value={formik.values.pallet_jack}
                      checked={formik.values.pallet_jack}
                      onBlur={formik.handleBlur}
                      isInvalid={formik.touched.pallet_jack && !!formik.errors.pallet_jack}
                      feedbackError={formik.errors.pallet_jack}
                    />
                  </FormGroup>
                </Col>
                <Col md={4}>
                  <FormGroup>
                    <InputCustom
                      ...
                      name="true_dock_high"
                      id="true_dock_high"
                      label="True Dock High"
                      isCheck={true}
                      onChange={formik.handleChange}
                      // value={formik.values.true_dock_high}
                      checked={formik.values.true_dock_high}
                      onBlur={formik.handleBlur}
                      isInvalid={formik.touched.true_dock_high && !!formik.errors.true_dock_high}
                      feedbackError={formik.errors.true_dock_high}
                    />
                  </FormGroup>
                </Col>
                <Col md={4}>
                  <FormGroup>
                    <InputCustom
                      ...
                      isCheck={true}
                      onChange={formik.handleChange}
                      // value={formik.values.tanker_endorsement}
                      checked={formik.values.tanker_endorsement}
                      onBlur={formik.handleBlur}
                      isInvalid={formik.touched.tanker_endorsement && !!formik.errors.tanker_endorsement}
                      feedbackError={formik.errors.tanker_endorsement}
                    />
                  </FormGroup>
                </Col>
              </Row>
                ...
                <Col md={6}>
                  <FormGroup>
                    ...
                    <InputCustom
                      ...
                      checked={formik.values.is_expirable}
                      onBlur={formik.handleBlur}
