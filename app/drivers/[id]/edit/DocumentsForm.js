...
const DocumentsForm = ({ userId, data }) => {
    ...
    const lFrontUrl = data.driverData.license_details
        ? `${backendUrl}/${data.driverData.license_details.license_photo_front}`
        : '/assets/images/placeholder.jpg'
    const lBackUrl = data.driverData.license_details
        ? `${backendUrl}/${data.driverData.license_details.license_photo_back}`
        : '/assets/images/placeholder.jpg'
    const iFrontUrl = data.driverData.insurance_details
        ? `${backendUrl}/${data.driverData.insurance_details.insurance_photo_front}`
        : '/assets/images/placeholder.jpg'
    const iBackUrl = data.driverData.insurance_details
        ? `${backendUrl}/${data.driverData.insurance_details.insurance_photo_back}`
        : '/assets/images/placeholder.jpg'
    ...
    const [countryName, setCountryName] = useState(
        data.driverData.license_details
    ...
    const formik = useFormik({
        initialValues: {
            ...
            license_number: data.driverData.license_details
                ? data.driverData.license_details.license_number
                : '',
            license_expiry_date: data.driverData.license_details
                ? data.driverData.license_details.license_expiry_date
                : '',
            license_issuance_country: countryName,
            license_issuance_state: stateName,
        ...
        validationSchema: Yup.object({
            ...
            license_issuance_country: Yup.string().required(
                'Please Select License Issuance Country',
            ),
            license_issuance_state: Yup.string().required(
                'Please Select License Issuance State',
            ),
            license_photo_front: Yup.mixed().required(
                'Please Select License Front',
            ),
            license_photo_back: Yup.mixed().required(
                'Please Select License Back',
            ),
            insurance_number: Yup.string().required(
                'Insurance Number is required',
            ),
            insurance_expiry_date: Yup.date().required(
                'Insurance Expiry Date is required',
            ),
            insurance_photo_front: Yup.mixed().required(
                'Please Select Insurance Front',
            ),
            insurance_photo_back: Yup.mixed().required(
                'Please Select Insurance Back',
            ),
        }),
        onSubmit: async values => {
            ...
            try {
                ...
                await axios.post(
                    `/api/drivers/${id}/updateDocuments`,
                    formData,
                    {
                        headers: {
            ...
            <Row>
                ...
                <Col md={6} className="mb-6">
                    <FormGroup>
                        ...
                        />
                        {formik.touched.license_expiry_date &&
                ...
                <Col md={6} className="mb-6">
                    <FormGroup>
                        <Label htmlFor="license_issuance_country">
                            Country
                        </Label>
                        <CountrySelect
                        ...
                        />
                        {formik.touched.license_issuance_country &&
                        formik.errors.license_issuance_country ? (
                ...
                <Col md={6} className="mb-6">
                    <FormGroup>
                        ...
                        />
                        {formik.touched.license_issuance_state &&
                        formik.errors.license_issuance_state ? (
                ...
                <Col md={6} className="mb-6">
                    <FormGroup>
                        ...
                        />
                        {formik.touched.license_photo_front &&
                        formik.errors.license_photo_front ? (
                ...
                <Col md={6} className="mb-6">
                    <FormGroup>
                        ...
                        />
                        {formik.touched.license_photo_back &&
                        formik.errors.license_photo_back ? (
                ...
                <Col md={6} className="mb-6">
                    <FormGroup>
                        ...
                        />
                        {formik.touched.insurance_number &&
                ...
                <Col md={6} className="mb-6">
                    <FormGroup>
                        <Label htmlFor="insurance_photo_front">
                            Insurance Front
                        </Label>
                        <InputCustom
                            type="file"
                        ...
                        />
                        {formik.touched.insurance_photo_front &&
                        formik.errors.insurance_photo_front ? (
                ...
                <Col md={6} className="mb-6">
                    <FormGroup>
                        <Label htmlFor="insurance_photo_back">
                            Insurance Back
                        </Label>
                        <InputCustom
                            type="file"
                        ...
                        />
                        {formik.touched.insurance_photo_back &&
                        formik.errors.insurance_photo_back ? (
                ...
                <SubmitButton
                    className="bg-gradients w-1/4 m-auto"
